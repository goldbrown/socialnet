...
import com.socialnet.android.gson.Forecast;
import com.socialnet.android.gson.OneSentenceResponse;
import com.socialnet.android.gson.Weather;
import com.socialnet.android.service.AutoUpdateService;
...
//    private TextView comfortText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("WeatherActivity", "onCreate: Build.VERSION.SDK_INT is " + Build.VERSION.SDK_INT);
...
//        comfortText = (TextView) findViewById(R.id.comfort_text);
        ...
        if (weatherString != null) {
            // 有缓存时直接解析天气数据
            LogUtil.logi("WeatherActivity.onCreate", "hit data cache");
            Weather weather = Utility.handleWeatherResponse(weatherString);
            mWeatherId = weather.basic.weatherId;
            showWeatherInfo(weather);
        } else {
            // 无缓存时去服务器查询天气
            LogUtil.logi("WeatherActivity.onCreate", "miss data cache");
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (oneSentenceResponse != null && StrUtil.isNotBlank(oneSentenceResponse.getContent())) {
                            String sentance = oneSentenceResponse.getContent();
                            oneSentenceText.setText(sentance);
                        } else {
                            Toast.makeText(WeatherActivity.this, "获取名句失败", Toast.LENGTH_SHORT).show();
                        }
                        swipeRefresh.setRefreshing(false);
                    }
                });
